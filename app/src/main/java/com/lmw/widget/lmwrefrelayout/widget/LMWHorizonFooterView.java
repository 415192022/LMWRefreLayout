...
public class LMWHorizonFooterView extends DefaultFooterView {
    ...
    public LMWHorizonFooterView(Context context) {
        this(context, null);
    }

    public LMWHorizonFooterView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LMWHorizonFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFooter = inflater.inflate(R.layout.load_horizon_more, this, false);
