...
public class LMWHorizonHeaderView extends DefaultHeaderView {
    ...
    public LMWHorizonHeaderView(Context context) {
        this(context, null);
    }

    public LMWHorizonHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LMWHorizonHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeader = inflater.inflate(R.layout.refresh_horizon_head, this, false);
